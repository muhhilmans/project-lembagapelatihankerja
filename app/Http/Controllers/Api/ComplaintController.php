...
class ComplaintController extends Controller
{
    ...
    public function allComplaintWork()
    {
        ...
        $complaints = Complaint::with(['application'])->where('servant_id', $user->id)->paginate(10);
                ...
                'complaints' => [
                    'data' => $complaints->map(function ($query) {
                        return [
                            ...
                            'file' => $query->file,
                            'work_detail' => [
                                'name' => $query->application->employe ? $query->application->employe->name : $query->application->vacancy->user->name,
                                'status' => $query->application->status,
                                'salary' => $query->application->salary,
                                'work_start_date' => $query->application->work_start_date,
                            ],
