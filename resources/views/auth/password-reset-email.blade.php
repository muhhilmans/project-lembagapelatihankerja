        ...
        <tbody>
            <tr>
                <td style="padding: 20px; text-align: left; color: #333333;">
                    ...
                    <p style="font-size: 16px; line-height: 1.5;">Kami menerima permintaan untuk mereset password Anda. Klik tombol di bawah ini untuk melanjutkan proses reset password:</p>
                    <div style="text-align: center; margin: 20px 0;">
                        <a href="{{ $link }}" style="background-color: #007bff; color: #ffffff; padding: 10px 20px; text-decoration: none; font-size: 16px; border-radius: 5px;">Reset Password</a>
                    </div>
                    <p style="font-size: 16px; line-height: 1.5;">Jika Anda tidak meminta reset password, Anda dapat mengabaikan email ini.</p>
