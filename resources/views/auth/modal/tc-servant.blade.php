        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-left">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="agreeTerms">Dengan mencentang ini, calon Mitra ART dianggap
                        telah membaca,memahami, dan menyetujui semua
                        syarat dan ketentuan ini.</label>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Tutup</button>
                <button type="submit" id="confirmRegistration" class="btn btn-primary" disabled>Setuju &
                    Daftar</button>
            </div>
        </div>
    </div>
