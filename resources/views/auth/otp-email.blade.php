        ...
        <tbody>
            <tr>
                <td style="padding: 20px; text-align: left; color: #333333;">
                    ...
                    <p style="font-size: 16px; line-height: 1.5;">Terima kasih telah mendaftar. Silakan gunakan kode OTP berikut untuk verifikasi akun Anda:</p>
                    <div style="text-align: center; margin: 20px 0;">
                        <h2 style="background-color: #007bff; color: #ffffff; padding: 10px 20px; text-decoration: none; font-size: 16px; border-radius: 5px;">{{ $otp }}</h2>
                    </div>
                    <p style="font-size: 16px; line-height: 1.5;">Kode ini berlaku selama 5 menit. Jika Anda tidak merasa mendaftar, Anda dapat mengabaikan email ini.</p>
