                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="is_bank"
                                        name="is_bank"
                                        {{ old('is_bank', $data->servantDetails->is_bank) == 1 ? 'checked' : '' }}>
                                ...
                                <div id="bank-details"
                                    class="{{ old('is_bank', $data->servantDetails->is_bank) == 1 ? '' : 'd-none' }}">
                                    <div class="form-group">
                                        <label for="bank_name">Nama Bank <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="bank_name" name="bank_name"
                                            value="{{ old('bank_name', $data->servantDetails->bank_name) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="account_number"
                                            name="account_number"
                                            value="{{ old('account_number', $data->servantDetails->account_number) }}"
                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="is_bpjs"
                                        name="is_bpjs"
                                        {{ old('is_bpjs', $data->servantDetails->is_bpjs) == 1 ? 'checked' : '' }}>
                                ...
                                <div id="bpjs-details"
                                    class="{{ old('is_bpjs', $data->servantDetails->is_bpjs) == 1 ? '' : 'd-none' }}">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="type_bpjs" name="type_bpjs"
                                            value="{{ old('type_bpjs', $data->servantDetails->type_bpjs) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="number_bpjs" name="number_bpjs"
                                            value="{{ old('number_bpjs', $data->servantDetails->number_bpjs) }}"
                            ...
                            <div class="input-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="photo" name="photo"
                                        aria-describedby="inpoPhoto" accept="image/*" {{ $data->servantDetails->photo ? null : 'required' }}>
                            ...
                            <div class="input-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="identity_card"
                                        name="identity_card" aria-describedby="inpoIdentityCard" accept="image/*" {{ $data->servantDetails->identity_card ? null : 'required' }}>
