<div class="modal fade" id="rejectModal-{{ $data->id }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tidak Setuju Memberhentikan Pekerja</h5>
            ...
            @if ($data->employe_id != null)
                <form method="POST" action="{{ route('applicant-hire.change', $data->id) }}">
                    ...
                    <div class="modal-body text-left">
                        ...
                        Apakah anda yakin untuk memperpanjang kontrak <b>{{ $data->servant->name }}</b> ini?
