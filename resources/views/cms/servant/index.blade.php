    ...
    <div class="card p-4 shadow-sm mb-4">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="d-flex align-items-center">
                    <input type="range" id="filterMinExperience" class="form-control-range" min="0" max="40"
                        value="1">
                    <span class="ml-2 mr-2">Min <span id="minExperienceLabel">1</span> Tahun</span>
                    <input type="range" id="filterMaxExperience" class="form-control-range" min="0" max="40"
                        value="40">
    ...
    <div class="row mb-4" id="servantList">
        @if ($datas->isEmpty())
            <div class="col-12 text-center">
                <p class="text-muted text-center">Belum ada pembantu</p>
            </div>
        @else
