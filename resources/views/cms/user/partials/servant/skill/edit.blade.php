    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST"
                    action="{{ route('users-servant.update.skill', ['user' => $user->id, 'skill' => $dataSkill->id]) }}">
                    @csrf
                    @method('PUT')
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('users-servant.destroy.skill', ['user' => $user->id, 'skill' => $dataSkill->id]) }}">
                    @csrf
                    @method('DELETE')
