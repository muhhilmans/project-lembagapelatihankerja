<section class="banner-category">
      ...
      <div class="row g-4 justify-content-center position-relative">
         <div class="col-lg-4 col-md-6">
            <div class="bn-category-item">
               ...
               <p>
                 Kami siap membantu Anda kapan saja, dengan layanan yang tersedia selama 24 jam setiap hari untuk memenuhi kebutuhan rumah tangga Anda.
               </p>
         ...
         <div class="col-lg-4 col-md-6">
            <div class="bn-category-item">
               ...
               <p>
                 Nikmati penawaran layanan berkualitas tinggi dengan harga yang kompetitif, tanpa biaya admin di awal. Solusi hemat untuk kenyamanan Anda.
               </p>
               <a href="#service" class="d-flex cate-btn align-items-center gap-xl-3 gap-2">
                  Layanan Kami
                  <svg width="32" height="8" viewBox="0 0 32 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M31.3536 4.35355C31.5488 4.15829 31.5488 3.84171 31.3536 3.64645L28.1716 0.464466C27.9763 0.269204 27.6597 0.269204 27.4645 0.464466C27.2692 0.659728 27.2692 0.976311 27.4645 1.17157L30.2929 4L27.4645 6.82843C27.2692 7.02369 27.2692 7.34027 27.4645 7.53553C27.6597 7.7308 27.9763 7.7308 28.1716 7.53553L31.3536 4.35355ZM0 4.5H31V3.5H0V4.5Z" fill="#032B52"/>
                  </svg>                     
   ...
   <div class="company-about-section pt-120" id="about">
      <div class="container">
            ...
            <div class="row">
               <div class="col-xxl-6 col-xl-6 col-lg-7">
                  <div class="about-our-companycontent position-relative">
                     <div class="cmn-section-title apointment-content">
                        <a href="#about" class="cmn--btn cmn-alt1 cmn-apint wow fadeInDown" data-wow-delay="0.5s">
                           <span>
                              Tentang Kami
                           </span>
                        </a>
                        <h2 class="text-white wow fadeInDown" data-wow-delay="0.8s">
                          Nikmati Hidup Lebih Mudah Bersama ART Profesional
                        </h2>
                        <p class="test n0-clr wow fadeInDown" data-wow-delay="0.9s">
                          Temukan ART terbaik di Jabodetabek melalui layanan yang cepat, transparan, dan terpercaya. Kami hadir untuk memenuhi kebutuhan rumah tangga Anda dengan solusi yang mudah dan praktis.
                        </p>
                     </div>
                     <div class="about-indetails">
                        <div class="indetails-item wow fadeInUp" data-wow-delay="0.5s">
                           ...
                           <p>
                             Kami menjamin layanan dengan standar terbaik untuk memberikan hasil yang memuaskan.
                           </p>
                        </div>
                        <div class="indetails-item wow fadeInDown" data-wow-delay="0.6s">
                           ...
                           <p>
                             Setiap ART kami adalah tenaga terlatih dengan sikap kerja yang profesional.
                           </p>
                        </div>
                        <div class="indetails-item wow fadeInUp" data-wow-delay="0.7s">
                           ...
                           <p>
                             Kami menjaga kepercayaan Anda dengan proses transparan dan komunikasi yang jelas.
                           </p>
                        </div>
                        <div class="indetails-item wow fadeInDown" data-wow-delay="0.8s">
                           ...
                           <p>
                             Dengan perlindungan BPJS Ketenagakerjaan untuk ART, kami memastikan keamanan dan kenyamanan bersama.
                           </p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-xxl-6 col-xl-6 col-lg-5">
                  <div class="about-company-thumb position-relative">
                     <img src="{{ asset('landing/assets/images/about/about.png') }}" alt="">
                  </div>
               </div>
            </div>
