...
<head>
    ...
    <style>
        /* Container untuk floating WhatsApp */
        .whatsapp-container {
            position: fixed;
            bottom: 20px;
            right: 20px;
...
<body>
    ...
    <div class="whatsapp-container">
        <div id="whatsappOptions" class="whatsapp-options">
            <div class="whatsapp-card" onclick="redirectToWhatsApp('klien')">
                <p>Client</p>
            </div>
            <div class="whatsapp-card" onclick="redirectToWhatsApp('mitra')">
                <p>Mitra</p>
            </div>
        </div>
        <div class="whatsapp-icon" onclick="toggleWhatsAppOptions()">
    ...
    <script>
        ...
        function redirectToWhatsApp(type) {
            ...
            if (type === "mitra") {
                url = "https://wa.link/gdks6n";
            } else if (type === "klien") {
                url = "https://wa.link/2mtxf9";
            }
